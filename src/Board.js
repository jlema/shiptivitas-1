...
export default class Board extends React.Component {
  ...
  componentDidMount = () => {
    ...
    this.drake.on('drop', (el, target, source, sibling) => {
      ...
      // the cancel method will gracefully cancel the drag action on an element managed by drake
      ...
      if (clientsFromKey === clientsToKey) {
        ...
        this.setState({clients: { ...this.state.clients, [clientsFromKey]: clientsFromCopy, [clientsToKey]: clientsToCopy }});
      }
